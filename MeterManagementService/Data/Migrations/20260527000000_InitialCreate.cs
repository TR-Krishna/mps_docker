...
namespace MeterManagementService.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSmart               = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    IsPrepaid             = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ...
                    TodEnabled            = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                ...
                constraints: t => t.PrimaryKey("PK_Meters", x => x.Id));
